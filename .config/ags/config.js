...
import { formatIcons, persistentWorkspaces } from "./workspaces.js";
  ...
  Widget.Label({
    ...
    setup: (self) =>
      self
        ...
        .poll(1000, (self) => execAsync(["date", "+%I:%M:%S %p %b %e"]).then((date) => (self.label = date))),
  });
